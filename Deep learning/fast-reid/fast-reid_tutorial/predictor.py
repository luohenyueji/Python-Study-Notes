...
class FeatureExtractionDemo(object):
    ...
    def run_on_image(self, original_image):
        ...
        """
        # the model expects RGB inputs opencv输入图像的顺序是bgr，这里更换为rgb顺序
        original_image = original_image[:, :, ::-1]
        # Apply pre-processing to image. 图像大小重置
